...
function ArrowLeft(props: IAction){
    return (<div onClick={props.action}><svg width="60" height="60" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <filter id="filter0_d_0_1" x="0" y="0.758545" width="48" height="48" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
